    ...
    if (request.action === "getHTMLContent") {
      ...
      fetch(
        ...
        .then((data) => {
          ...
          addElementIfNotExists('link[rel="preconnect"][href="https://fonts.googleapis.com"]', () => {
          ...
          addElementIfNotExists('link[rel="preconnect"][href="https://fonts.gstatic.com"]', () => {
          ...
          addElementIfNotExists('link[rel="stylesheet"][href*="fonts.googleapis.com/css2"]', () => {
          ...
          addElementIfNotExists('link[rel="stylesheet"][href*="assets/css/popup.css"]', () => {
